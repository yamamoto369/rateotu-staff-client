...
const mapStateToProps = ({ menu, settings, accounts }) => ({
...
class MenuTop extends React.Component {
  ...
  generateMenuItems = () => {
    const { user, menuData = [] } = this.props
    const generateItem = item => {
      const { key, title, url, icon, disabled, divider, target, roles } = item
